...
class AdsService {
  ...
  static const String _rewardedInterstitialIOS = 'ca-app-pub-5549243085914479/6329979903';
  ...
  static const String _appOpenProdIOS = 'ca-app-pub-5549243085914479/3077130601';
  ...
  Future<void> maybeShowInterstitial() async {
    ...
    ad.fullScreenContentCallback = FullScreenContentCallback(
      ...
      onAdFailedToShowFullScreenContent: (a, _) {
        a.dispose(); _interstitial = null;
        _showingFullScreenAd = false; _loadInterstitial();
      },
    );
    await ad.show();
  }
  ...
  Future<bool> showRewarded() async {
    ...
    ad.fullScreenContentCallback = FullScreenContentCallback(
      onAdDismissedFullScreenContent: (a) {
        ...
        _showingFullScreenAd = false; _loadRewarded();
